...
public class DbInitializer
{
	...
	{
		/*
			We're going to need to get a hold of our service.
			The DB context service, but before we've got the ability to 
			actually inject this service into a class, once the framework has
			got the application up and running, and the way that we'll need
			to do that is we'll need to create a scope for the service
			inside here itself.

			We add the using keyword here because this will allow the framework
			once we're finished wiht this method, to dispose of any of the
			services we've used inside this scope that we're creating.
		*/
	...
	private static void SeedData(AuctionDbContext? context)
	{
		...
		// Update the database with a migration or create it if it doesn't exist
		...
		// AddRange will let entity framework keep the auctions in memory
